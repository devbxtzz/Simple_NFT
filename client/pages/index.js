...
import NFT from '../utils/SimpleNFT.json'
	...
	const mintCharacter = async () => {
		try {
			...
			if (ethereum) {
				...
				let nftTx = await nftContract.createSimpleNFT()
	...
	return (
		<div className='flex flex-col items-center pt-32 bg-[#0B132B] text-[#d3d3d3] min-h-screen'>
			...
			<div className='text-xl font-semibold mb-20 mt-4'>
				<a
					href={`https://mumbai.opensea.com/collection/${nftContractAddress}`}
					target='_blank'
				>
